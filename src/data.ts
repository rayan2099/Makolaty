...
const RAW_INITIAL_MENU: MenuItem[] = [
  ...
  { id: 'ml-6', nameAr: 'وجبة كرسبي جامبو', nameEn: 'Crispy Jumbo Meal', category: 'meals', price: 20, calories: 2033, image: '/menu/meals/crispy-jumbo-meal.jpeg' },
  { id: 'ml-7', nameAr: 'وجبة ساندويتش تورتيلا', nameEn: 'Tortilla Sandwich Meal', category: 'meals', price: 20, calories: 800, image: '/menu/meals/tortilla-meal.jpeg' },
  { id: 'ml-3', nameAr: 'وجبة كلاسيك كرسبي', nameEn: 'Classic Crispy Meal', category: 'meals', price: 23, calories: 480, image: '/menu/meals/classic-crispy-meal.jpeg' },
  { id: 'ml-8', nameAr: 'وجبة سبيشل كرسبي', nameEn: 'Special Crispy Meal', category: 'meals', price: 23, calories: 480, image: '/menu/meals/special-crispy-meal.jpeg' },
  { id: 'ml-9', nameAr: 'وجبة كلاسيك كرسبي حراق', nameEn: 'Classic Spicy Crispy Meal', category: 'meals', price: 23, calories: 480, image: '/menu/meals/classic-spicy-crispy-meal.jpeg' },
  { id: 'ml-2', nameAr: 'وجبة برجر لحم مشوي', nameEn: 'Grilled Beef Burger Meal', category: 'meals', price: 23, calories: 465, image: '/menu/meals/grilled-beef-burger-meal.jpeg' },
  { id: 'ml-10', nameAr: 'وجبة برجر لحم كراميل', nameEn: 'Caramel Beef Burger Meal', category: 'meals', price: 23, calories: 460, image: '/menu/meals/caramel-beef-burger-meal.jpeg' },
  { id: 'ml-11', nameAr: 'وجبة برجر لحم كراميل دبل', nameEn: 'Double Caramel Beef Burger Meal', category: 'meals', price: 33, calories: 720, image: '/menu/meals/double-caramel-beef-burger-meal.jpeg' },
  { id: 'ml-1', nameAr: 'وجبة برجر دجاج مشوي', nameEn: 'Grilled Chicken Burger Meal', category: 'meals', price: 18, calories: 580, image: '/menu/meals/grilled-chicken-burger-meal.jpeg' },
  { id: 'ml-5', nameAr: 'وجبة برجر دجاج', nameEn: 'Chicken Burger Meal', category: 'meals', price: 16, calories: 300, image: '/menu/meals/fried-chicken-burger-meal.jpeg' },
  { id: 'ml-12', nameAr: 'وجبة برجر لحم مشوي دبل', nameEn: 'Double Grilled Beef Burger Meal', category: 'meals', price: 33, calories: 660, image: '/menu/meals/double-grilled-beef-burger-meal.jpeg' },
  { id: 'ml-13', nameAr: 'وجبة برجر دجاج مشوي دبل', nameEn: 'Double Grilled Chicken Burger Meal', category: 'meals', price: 26, calories: 470, image: '/menu/meals/double-grilled-chicken-burger-meal.jpeg' },
  ...
  { id: 'sw-5', nameAr: 'كلاسيك كرسبي', nameEn: 'Classic Crispy Burger', category: 'burgers', price: 15, calories: 480, image: '/menu/burgers/crispy.jpeg' },
  { id: 'sw-6', nameAr: 'سبيشل كرسبي', nameEn: 'Special Crispy Burger', category: 'burgers', price: 15, calories: 480, image: '/menu/burgers/crispy.jpeg' },
  { id: 'sw-7', nameAr: 'كلاسيك كرسبي حراق', nameEn: 'Classic Spicy Crispy Burger', category: 'burgers', price: 15, calories: 480, image: '/menu/burgers/crispy.jpeg' },
  { id: 'sw-8', nameAr: 'برجر لحم مشوي', nameEn: 'Grilled Beef Burger', category: 'burgers', price: 15, calories: 465, image: '/menu/burgers/grilled-beef.jpeg' },
  { id: 'sw-9', nameAr: 'برجر لحم كراميل', nameEn: 'Caramel Beef Burger', category: 'burgers', price: 15, calories: 352, image: '/menu/burgers/grilled-beef.jpeg' },
  { id: 'sw-10', nameAr: 'برجر لحم كراميل دبل', nameEn: 'Double Caramel Beef Burger', category: 'burgers', price: 25, calories: 555, image: '/menu/burgers/grilled-beef.jpeg' },
  { id: 'sw-11', nameAr: 'برجر دجاج مشوي', nameEn: 'Grilled Chicken Burger', category: 'burgers', price: 10, calories: 580, image: '/menu/burgers/grilled-chicken.jpeg' },
  { id: 'sw-12', nameAr: 'برجر دجاج', nameEn: 'Chicken Burger', category: 'burgers', price: 8, calories: 300, image: '/menu/burgers/fried-chicken.jpeg' },
  { id: 'sw-13', nameAr: 'برجر لحم مشوي دبل', nameEn: 'Double Grilled Beef Burger', category: 'burgers', price: 25, calories: 660, image: '/menu/burgers/grilled-beef.jpeg' },
  { id: 'sw-14', nameAr: 'برجر دجاج مشوي دبل', nameEn: 'Double Grilled Chicken Burger', category: 'burgers', price: 18, calories: 470, image: '/menu/burgers/grilled-chicken.jpeg' },
  { id: 'sw-15', nameAr: 'زنجر برجر', nameEn: 'Zinger Burger', category: 'burgers', price: 10, calories: 650, image: '/menu/burgers/zinger.jpeg' },
  ...
  {
    id: 'dr-1', nameAr: 'بيبسي', nameEn: 'Pepsi', category: 'drinks', price: 3, calories: 150,
    sizes: [
      { name: 'صغير', price: 3, calories: 150, image: '/menu/drinks/pepsi-can.png' },
      { name: 'وسط', price: 5, image: '/menu/drinks/pepsi-medium.png' },
      { name: 'كبير', price: 9, image: '/menu/drinks/pepsi-large.png' },
    ],
  ...
  { id: 'dr-5', nameAr: 'سفن أب', nameEn: '7 Up', category: 'drinks', price: 3, calories: 140, image: '/menu/drinks/7up-can-v2.png' },
  { id: 'dr-6', nameAr: 'سفن أب زيرو', nameEn: '7 Up Zero', category: 'drinks', price: 3, calories: 0, image: '/menu/drinks/7up-zero-can-v2.png' },
  { id: 'dr-7', nameAr: 'ميرندا حمضيات', nameEn: 'Mirinda Citrus', category: 'drinks', price: 3, calories: 150, image: '/menu/drinks/mirinda-citrus-can-v2.png' },
];
